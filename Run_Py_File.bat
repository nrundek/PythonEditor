...
if not exist "programi" mkdir "programi"

echo Pokretanje Python datoteke.
echo Mapa pokretača:
echo %cd%
echo.
echo Datoteke se traže u ovoj mapi i u podmapi programi.
echo.
...
if "%COUNT%"=="0" (
    ...
    echo Spremi .py datoteku u istu mapu u kojoj je ova BAT datoteka ili u podmapu programi.
    echo.
    pause
    exit /b 1
)
